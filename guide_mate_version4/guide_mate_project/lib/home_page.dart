...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _navigateToProfilePage() async {
    try {
      await NavigationHelper.navigateToProfile(widget.email, context); // Pass the email to the navigation helper
    } catch (e) {
      print('Error navigating to profile page: $e');
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error navigating to profile page')));
    }
  }
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => DetailsPage(
              ...
              imageUrl: (tripData['media_files'] != null && tripData['media_files'].isNotEmpty)
                  ? tripData['media_files'][0]
                  : 'assets/images/default_trip_image.png',
              imageUrls: (tripData['media_files'] != null && tripData['media_files'].isNotEmpty)
        ...
        child: Column(
          ...
          children: [
            Stack(
              children: [
                Image.network(
                  (tripData['media_files'] != null && tripData['media_files'].isNotEmpty)
                      ? tripData['media_files'][0]
                      : 'assets/images/default_trip_image.png',
                  fit: BoxFit.cover,
...
// }
//
// // Category and image cards section
// // Expanded(
// //   child: Padding(
// //     padding: const EdgeInsets.all(8.0),
// //     child: Column(
...
// //                         title: 'Evening Red Dunes Desert Safari with Buffet Dinner',
// //                         location: 'Dubai, UAE',
// //                         description: '7 hours - Pickup available',
// //                         imageUrl: 'assets/images/taj_mahal.png',
// //                         price: 202,
// //                         rating: 4.9,
// //                       ),
// //                     ),
...
// //                                       size: 20,
// //                                     ),
// //                                     Text('4.9', style: TextStyle(color: Colors.teal)),
// //                                   ],
// //                                 ),
// //                                 Icon(
// //                                   Icons.more_vert,
...
// //                     MaterialPageRoute(
// //                       builder: (context) => const DetailsPage(
// //                         title: 'Day Ticket to Aquarium and Underwater Zoo',
// //                         location: 'Dubai, UAE',
// //                         description: 'Pickup available',
// //                         imageUrl: 'assets/images/halongbay.png',
// //                         price: 150,
// //                         rating: 4.8,
// //                       ),
// //                     ),
...
// //                           children: [
// //                             Text(
// //                               'Day Ticket to Aquarium and Underwater Zoo',
// //                               style: TextStyle(
// //                                 fontSize: 16,
// //                                 fontWeight: FontWeight.bold,
// //                                 color: Colors.teal,
...
// //                                       size: 20,
// //                                     ),
// //                                     Text('4.8', style: TextStyle(color: Colors.teal)),
// //                                   ],
// //                                 ),
// //                                 Icon(
// //                                   Icons.more_vert,
