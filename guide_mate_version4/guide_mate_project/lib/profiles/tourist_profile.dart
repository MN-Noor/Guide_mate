...
//
//   const TouristProfilePage({Key? key, required this.userEmail}) : super(key: key);
//
//   @override
...
//                   child: Image.asset(
//                     'assets/images/tourist.png', // Path to your uploaded image
//                     fit: BoxFit.cover,
...
//                 buildProfileItem('Languages Spoken', userData['languages_spoken']?.join(', ') ?? ''),
//                 buildProfileItem('Preferred Destinations', userData['preferred_destinations']?.join(', ') ?? ''),
//                 buildProfileItem('Preferred Activities', userData['preferred_activities'].toString()),
//                 buildProfileItem('Phone Number', userData['phone_number'].toString()),
//                 buildProfileItem('Email', userData['email'].toString()),
//                 // buildProfileItem('Important Note', userData['importantNote'].toString()),
//               ],
//             ),
//           ),
//         ),
...
class _TouristProfilePageState extends State<TouristProfilePage> {
  ...
  Future<void> pickImage() async {
    ...
    if (pickedFile != null) {
      ...
      try {
        final storageRef = FirebaseStorage.instance.ref().child('tourist_profile_images/${widget.userEmail}');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: _profileImage != null
                        ...
                        : AssetImage('assets/images/tourist.png')) as ImageProvider<Object>,
                  ),
                ),
                SizedBox(height: 20),
                Text(
                ...
                buildProfileItem('Languages Spoken', userData['languages_spoken']?.join(', ') ?? ''),
                buildProfileItem('Preferred Destinations', userData['preferred_destinations']?.join(', ') ?? ''),
                buildProfileItem('Preferred Activities', userData['preferred_activities']?.join(', ') ?? ''),
                buildProfileItem('Phone Number', userData['phone_number'].toString()),
                buildProfileItem('Email', userData['email'].toString()),
                buildProfileItem('Important Note', userData['important_note']?.toString() ?? ''),
              ],
            ),
          ),
        ),
