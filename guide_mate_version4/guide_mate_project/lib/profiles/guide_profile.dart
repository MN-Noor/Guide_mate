...
class _GuideProfilePageState extends State<GuideProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> userData = _userSnapshot!.data() as Map<String, dynamic>;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: _profileImage != null
                        ...
                        ? FileImage(File(userData['profilePhoto'])) as ImageProvider
                ...
                buildProfileItem('Years of Experience', userData['experience'].toString()),
                buildProfileItem('Specialty Areas', userData['speciality_areas']?.join(', ') ?? ''),
                buildProfileItem('Available Dates', formatDates(userData['available_dates'] ?? [])),
                buildProfileItem('Preferred Meeting Location', userData['preferred_meeting_locations']?.join(', ') ?? ''),
...
//         context,
//         MaterialPageRoute(
//           builder: (context) => EditGuideProfilePage(
...
//                   child: Image.asset(
//                     'assets/images/img.png', // Path to your uploaded image
//                     fit: BoxFit.cover,
